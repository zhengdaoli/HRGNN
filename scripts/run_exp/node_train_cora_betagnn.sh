...
for rewire_ratio in ${ratios[@]}; do
    ...
    if [ ${perturb_type} == "ori" ]; then
        ...
        tag=node_classification_${data_name}_${gnn_model_name}_${dt}_raito${rewire_ratio}_innerpG${inner_processes_G}_${perturb_type}_${use_hvo}_${ori_ratio}_lrG${lrG}_${gen_type}_${ggn_gnn_type}_heads${gat_heads}
    fi
