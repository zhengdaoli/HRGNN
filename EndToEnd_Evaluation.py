...
def main(model_configurations,
         outer_k, outer_processes, inner_k, inner_processes, result_folder, debug=False, repeat=False, pretrain=False):
    ...
    risk_assesser.risk_assessment(experiment_class, debug=debug, repeat=repeat, pretrain=pretrain)