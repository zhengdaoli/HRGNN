...
class ProGNN:
    ...
    def fit(self, features, adj, labels, idx_train, idx_val, **kwargs):
        ...
        best_val_loss = 10000
        early_stop_count = 0
        stop_util = 20 # early stop patience
        for epoch in range(args.epochs):
            ...
            for i in range(int(args.inner_steps)):
                val_loss = self.train_gcn(epoch, features, estimator.estimated_adj,
    ...
    def train_gcn(self, epoch, features, adj, labels, idx_train, idx_val):
        ...
        output = self.model(x=features, adj=adj)
    ...
    def train_adj(self, epoch, features, adj, labels, idx_train, idx_val):
        ...
        output = self.model(x=features, adj=normalized_adj)
